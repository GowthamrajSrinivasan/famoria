...
export const interactionService = {
  ...
  toggleLike: async (photoId: string, userId: string, collectionName: 'photos' | 'posts' = 'posts'): Promise<boolean> => {
    ...
    if (!snapshot.exists()) throw new Error("Photo/Post not found");
  ...
  subscribeToLikes: (photoId: string, callback: (userIds: string[]) => void, collectionName: 'photos' | 'posts' = 'posts') => {
    const photoRef = doc(db, collectionName, photoId);
